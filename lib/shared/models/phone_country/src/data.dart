...
/// Only BJ, CI, BF, CM, SN, ML are used in the app
final countries = [
  Country('Benin', 'BJ', 229, LengthRule.exact(10)),
  Country('Ivory Coast', 'CI', 225, LengthRule.exact(10)),
  Country('Burkina Faso', 'BF', 226, LengthRule.exact(10)),
  Country('Cameroon', 'CM', 237, LengthRule.exact(10)),
  Country('Senegal', 'SN', 221, LengthRule.exact(10)),
  Country('Mali', 'ML', 223, LengthRule.exact(10)),
];

final List<Country> allCcountries = <Country>[
  ...
  Country('American Samoa', 'AS', 1, LengthRule.exact(10)),
  Country('Andorra', 'AD', 376, LengthRule.oneOf([6, 8, 9])),
  Country('Angola', 'AO', 244, LengthRule.exact(9)),
  Country('Anguilla', 'AI', 1, LengthRule.exact(10)),
  Country('Antarctica', 'AQ', 672, LengthRule.exact(6)),
  Country('Antigua and Barbuda', 'AG', 1, LengthRule.exact(10)),
  ...
  Country('Benin', 'BJ', 229, LengthRule.exact(10)),
  Country('Bermuda', 'BM', 1, LengthRule.exact(10)),
  ...
  Country('British Virgin Islands', 'VG', 1, LengthRule.exact(10)),
  ...
  Country('Cayman Islands', 'KY', 1, LengthRule.exact(10)),
  ...
  Country('Dominica', 'DM', 1, LengthRule.exact(10)),
  Country('Dominican Republic', 'DO', 1, LengthRule.exact(10)),
  ...
  Country('Grenada', 'GD', 1, LengthRule.exact(10)),
  Country('Guam', 'GU', 1, LengthRule.exact(10)),
  Country('Guatemala', 'GT', 502, LengthRule.exact(8)),
  Country('Guernsey', 'GG', 44, LengthRule.range(7, 10)),
  ...
  Country('Isle of Man', 'IM', 44, LengthRule.range(7, 10)),
  ...
  Country('Jamaica', 'JM', 1, LengthRule.exact(10)),
  Country('Japan', 'JP', 81, LengthRule.range(9, 10)),
  Country('Jersey', 'JE', 44, LengthRule.range(7, 10)),
  ...
  Country('Montserrat', 'MS', 1, LengthRule.exact(10)),
  ...
  Country('Northern Mariana Islands', 'MP', 1, LengthRule.exact(10)),
  ...
  Country('Puerto Rico', 'PR', 1, LengthRule.exact(10)),
  ...
  Country('Saint Kitts and Nevis', 'KN', 1, LengthRule.exact(10)),
  Country('Saint Lucia', 'LC', 1, LengthRule.exact(10)),
  Country('Saint Martin', 'MF', 590, LengthRule.exact(9)),
  Country('Saint Pierre and Miquelon', 'PM', 508, LengthRule.exact(6)),
  Country('Saint Vincent and the Grenadines', 'VC', 1, LengthRule.exact(10)),
  ...
  Country('Sint Maarten', 'SX', 1, LengthRule.exact(10)),
  ...
  Country('Trinidad and Tobago', 'TT', 1, LengthRule.exact(10)),
  ...
  Country('Turks and Caicos Islands', 'TC', 1, LengthRule.exact(10)),
  Country('Tuvalu', 'TV', 688, LengthRule.oneOf([5, 6])),
  Country('U.S. Virgin Islands', 'VI', 1, LengthRule.exact(10)),
